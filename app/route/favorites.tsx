    ...
    <TouchableOpacity style={styles.card} activeOpacity={0.75} onPress={onPress}>
      ...
      <View style={styles.cardBody}>
        ...
        <View style={styles.statsRow}>
          ...
          <Text style={styles.statText}>👤 {route.author.username}</Text>
        </View>
      </View>
    </TouchableOpacity>
  );
...
export default function FavoritesScreen() {
  ...
  const load = useCallback(async () => {
    try {
      const data = await communityService.getMyFavorites();
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.empty}>
              ...
              <Text style={styles.emptySubtitle}>去路书广场发现感兴趣的路线吧</Text>
            </View>
          }
        />
      )}
...
const styles = StyleSheet.create({
  ...
  emptySubtitle: { fontFamily: 'SpaceGrotesk_400Regular', fontSize: 13, color: Colors.textMuted },
});
